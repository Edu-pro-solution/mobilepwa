...
const fetchQuestionsForSubject = async (subject, selectedTopics = [], limit = 50) => {
  try {
    ...
    const res = await fetch(
      `https://eduproapi.vercel.app/api/jamb/subject/${subject}/questions?${params.toString()}`
    );
 ...
 allSubjects.forEach((subject) => {
  ...
  // Force 50 questions
  fetchQuestionsForSubject(subject, config.selectedTopics, 50)
    .then((data) => {
